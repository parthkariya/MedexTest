                ...
                {logindata ? (
                  <div className="acc_wrapper">
                    <div className="first_col">
                      <lable className="acc_lable">Name :</lable>
                      <lable className="acc_lable_val">{logindata.name}</lable>
                      <lable className="acc_lable"> firstname :</lable>
                      <lable className="acc_lable_val">
                        {logindata.first_name}
                      </lable>
                      <lable className="acc_lable"> Last Name :</lable>
                      <lable className="acc_lable_val">
                        {logindata.last_name}
                      </lable>
                    </div>
                    ...
                    <div className="second_col">
                      <div className="email_col">
                        <lable className="acc_lable">Email Id : </lable>
                        <lable className="acc_lable_val">
                          {logindata.email}
                        </lable>
                      </div>
                      <div className="number_col">
                        <lable className="acc_lable">Mobile Number : </lable>
                        <lable className="acc_lable_val">
                          {logindata.number}
                        </lable>
                      </div>
